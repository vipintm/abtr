...
Module Module1
	...
	Const N As Integer = 624
	Const M As Integer = 397
	Const MATRIX_A As Integer = &H9908B0DF '/* constant vector a */
	Const UPPER_MASK As Integer = &H80000000 '/* most significant w-r bits */
	Const LOWER_MASK As Integer = &H7FFFFFFF '/* least significant r bits */
	
	'To avoid innecesary operations while using the Visual Basic interpreter:
	Const kDiffMN As Integer = M - N
	Const Nuplim As Integer = N - 1
	Const Muplim As Integer = M - 1
	Const Nplus1 As Integer = N + 1
	Const NuplimLess1 As Integer = Nuplim - 1
	Const NuplimLessM As Integer = Nuplim - M
	
	'static unsigned long mt[N];  /* the array for the state vector */
	'static int mti=N+1;          /* mti==N+1 means mt[N] is not initialized */
	Dim mt(Nuplim) As Integer '/* the array for the state vector */
	Dim mti As Integer
	
	
	'static unsigned long mag01[2]={0x0UL, MATRIX_A};
	'/* mag01[x] = x * MATRIX_A  for x=0,1 */
	Dim mag01(2) As Integer
	...
	Const k2_8 As Integer = 256
	Const k2_16 As Integer = 65536
	Const k2_24 As Integer = 16777216
	...
	Const kShl7 As Integer = 128 '128==2^7
	Const kShl15 As Integer = 32768 '32768==2^15
	
	'Constants for shift right operation:
	Const kShr1 As Integer = 2 '2==2^1
	Const kShr5 As Integer = 32 '32==2^5
	Const kShr6 As Integer = 64 '64==2^6
	Const kShr11 As Integer = 2048 '2048==2^11
	Const kShr18 As Integer = 262144 '262144==2^18
	Const kShr30 As Integer = 1073741824 '1073741824==2^30  used in init_X() functions
	
	'The following constant has its value defined by the authors of the
	'Mersenne Twister algorithm
	Const kDefaultSeed As Integer = 5489
	...
	Private Function uAdd(ByVal x As Integer, ByVal y As Integer) As Integer
	...
	Private Function uMult(ByVal x As Integer, ByVal y As Integer) As Integer
		
		
		Dim cc, bb, dd As Integer
		Dim gg, ff, hh As Integer
		Dim r1, r3, r2, r0 As Integer
		Dim tmp As Double
		...
		If tmp < k2_31Neg Then
			uMult = CInt(k2_32 + tmp)
		Else
			If tmp > k2_31b Then
				uMult = CInt(tmp - k2_32)
			Else
				uMult = CInt(tmp)
			End If
		End If
	...
	Private Function uDiv(ByVal x As Integer, ByVal y As Integer) As Integer
	...
	Private Function uDiv2(ByVal x As Double, ByVal y As Integer) As Double
	...
	Public Sub init_genrand(ByVal seed As Integer) 'void init_genrand(unsigned long s)
	...
	Public Function genrand_int32SignedLong() As Integer 'unsigned long genrand_int32(void)
	...
	Public Function genrand_int31() As Integer 'long genrand_int31(void)
		...
		genrand_int31 = CInt(uDiv2(genrand_int32(), kShr1))
	...
	Public Function GetRnd(ByRef Bound As Short) As Short
